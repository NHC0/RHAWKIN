...
thephuckinstart:
echo "\n";
userinput("Masukin web yg mau lu tes ");
...
if ($ip == "help")
  {
    ...
    echo "========\n";
    echo $fgreen . "[1] help:$cln Untuk lihat menu Help\n";
    echo $bold . $fgreen . "[2] fix:$cln Untuk install Modules wajib (Disarankan untuk pemula pengguna tool)\n";
    echo $bold . $fgreen . "[3] URL:$cln Masukkan nama domain yg ingin lu tes (Format:www.sample.com / sample.com)\n";
...
elseif (strpos($ip, '://') !== false)
  {
    echo $bold . $red . "\n[!] (HTTP/HTTPS) Terdeteksi dalam input! masukkan URL tanpa  Http/Https\n" . $CURLOPT_RETURNTRANSFER;
    goto thephuckinstart;
  }
elseif (strpos($ip, '.') == false)
  {
    echo $bold . $red . "\n[!] Invalid URL Format! Masukin URL yang valid BUJANG!!\n" . $cln;
    goto thephuckinstart;
  }
elseif (strpos($ip, ' ') !== false)
  {
    echo $bold . $red . "\n[!] Invalid URL Format! Masukin URL yang valid BUJANK!!\n" . $cln;
    goto thephuckinstart;
  }
else
  {
    echo "\n";
    userinput("Masukkan 1 Untuk HTTP ATAU Masukkan 2 Untuk HTTPS");
...
scanlist:
    ...
    echo $bold . $blue . "
      +--------------------------------------------------------------+
      +                  List Yg bisa di pake                        +
      +--------------------------------------------------------------+
      _______________——— TRANSLATE INDO BY NHC ———____________________
            $lblue Scanning Site : " . $fgreen . $ipsl . $ip . $blue . "
      \n\n";
    echo $yellow . " [0]  Basic scann$white (Judul Situs, Alamat IP, CMS, Cloudflare Deteksi, Robots.txt Scanner)$yellow \n [1]  Pencarian WIS \n [2]  Penacrian Geo-IP \n [3]  Ambil banner \n [4]  Pencari DNS \n [5]  Kalkulator Subnet \n [6]  NMAP Port Scan \n [7]  Pemindai subdomain \n [8]  Pembalikan pencarian IP & Deteksi CMS \n [9] Pemindai SQLi$white (Cari tautan/link dengan parameter dan pindai kesalahan bais SQLi)$yellow \n [10] Lihat dari sisi bloggerw$white (Informasi yg menarik bagi blogger)$yellow \n [11] Pindai WordPress$white (Dapat bekerja jika target menggunakan WP/WordPress)$yellow \n [12] Rayap/pindai web \n [13] Pencarian MX \n$magenta [A]  Pindai Semuanya - (Lumayan lama sih buat pindai semua) \n$blue [F]  Fix (Untuk cek modules yg hilang dan menginstall modules yg hilang) \n$fgreen [U]  Cek update terbaru \n$white [B]  Ganti web yg lain untuk di pindai (Kembali ke pemilihan umum :v ehh pemilihan situs) \n$red [Q]  Kluar yaa bujank \n\n" . $cln;
askscan:
    userinput("Silahkan pilih salah satu yaa bujang command yg tersedia");
    ...
    if (!in_array($scan, array(
      ...
      {
        echo $bold . $red . "\n[!] Lu masukin command apaan bujank? yg benerlah anjer! \n\n" . $cln;
        goto askscan;
      }
    else
      {
        ...
        elseif ($scan == 'q' | $scan == 'Q')
          {
            echo "\n\n\t Sayonara - Jangan lupa mandi ea kimak\n\n";
            die();
          }
        ...
        elseif ($scan == "0")
          {
            ...
            echo "\n$cln" . $lblue . $bold . "[+] Lagi di pindai bujang ... \n";
            echo $blue . $bold . "[i] Pindai Situs:\e[92m $ipsl" . "$ip \n";
            echo $bold . $yellow . "[S] Tipe pemindai : PEMINDAI DASAR" . $cln;
            echo "\n\n";
            echo $bold . $lblue . "[iNFO] Judul situs: " . $green;
            echo getTitle($reallink);
            echo $cln;
            $wip = gethostbyname($ip);
            echo $lblue . $bold . "\n[iNFO] Alamat IP: " . $green . $wip . "\n" . $cln;
            echo $bold . $lblue . "[iNFO] Server dari web: ";
            WEBserver($reallink);
            echo "\n";
            ...
            echo "\n\n";
            echo $bold . $yellow . "[*] Udah kelar di cek klik enter untuk lanjut atau CTRL+C untuk STOP\n\n";
        ...
        elseif ($scan == "1")
          {
            $reallink = $ipsl . $ip;
            $lwwww    = str_replace("www.", "", $ip);
            echo "\n$cln" . $lblue . $bold . "[+] Lagi dipindai ... \n";
            echo $blue . $bold . "[i] Lagi pindai situs:\e[92m $ipsl" . "$ip \n";
            echo $bold . $yellow . "[S] Tipe pemindai : PENCARI WIS" . $cln;
            echo $bold . $lblue . "\n[~] Hasil pencarian WIS: \n\n" . $cln;
            $urlwhois    = "http://api.hackertarget.com/whois/?q=" . $lwwww;
            $resultwhois = file_get_contents($urlwhois);
            echo $bold . $fgreen . $resultwhois;
            echo "\n\n";
            echo $bold . $yellow . "[*] Udah kelar bujank klik ENTER untuk lanjut atau CTRL+C untuk STOP\n\n";
            trim(fgets(STDIN, 1024));
            goto scanlist;
          }
        elseif ($scan == "2")
